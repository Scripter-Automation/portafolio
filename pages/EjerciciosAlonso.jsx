...
import PDFLoaderAlonso from "../Components/Utils/PDFLoader/PDFLoaderAlonso"
...
export default function EjerciciosAlonso() {
  ...
  return (
      <>
        ...
        <br></br>
        <br></br>
        { lista !== undefined && <PDFLoaderAlonso fileName={lista} ></PDFLoaderAlonso>}
      </>
