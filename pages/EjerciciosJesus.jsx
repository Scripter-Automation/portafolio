...
import PDFLoaderJesus from "../Components/Utils/PDFLoader/PDFLoaderJesus"
...
export default function EjerciciosJesus() {
      ...
      <>
        ...
        <FormControl fullWidth>
            ...
            >
                ...
                <MenuItem value="Impropias">Integrales Impropias</MenuItem>
                <MenuItem value="Simpson">Lista Regla de Simpson 1/3</MenuItem>
            </Select>
        </FormControl>
        </>
        <Typography>
            Si no se ven los PDFs puede verlos aqui <a style={{color:"blue"}} href='https://drive.google.com/file/d/1whZfe782yNy4cvOIhnAgWt8T8vg9Njdn/view?usp=sharing'>https://drive.google.com/drive/folders/1WwpRHq7Yda7FdP_d3i-uL8HMXDjtXMBh?usp=sharing</a>
        </Typography>
        <br></br>
        <br></br>
        { lista !== undefined && <PDFLoaderJesus fileName={lista} ></PDFLoaderJesus>}
      </>
